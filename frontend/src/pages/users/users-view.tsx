    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Activities AssignedTo</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.activities_assigned_to &&
                      Array.isArray(users.activities_assigned_to) &&
                      users.activities_assigned_to.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.activities_assigned_to?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
